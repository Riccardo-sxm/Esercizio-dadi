    ...
    public static void main(String[] args) throws Exception {
        ...
        while (cont) {
            ...
            for (int turno = 0; turno < 3; turno++) {
                    ...
                    System.out.println("Hai fatto: " + sommadadi); // faccio visualizzare la somma dei tiri dell'utente
                    dadopc1 = rnd.nextInt(6) + 1;
                    dadopc2 = rnd.nextInt(6) + 1;
                    sommadadipc = dadopc1 + dadopc2;
                    System.out.println("Il pc ha fatto: " + sommadadipc); // faccio visualizzare la somma dei tiri del pc
